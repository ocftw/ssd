...
!!! tip "提示"
    ...
    「資料管理與備份」包含課程主題中的「[檔案存取權限](../chapter/files_management/files_access.md){target="_blank"}」、「[資料備份與封存](../chapter/files_management/backup_archive.md){target="_blank"}」、「[更新軟體](../chapter/files_management/software_update.md){target="_blank"}」。
