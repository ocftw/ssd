...
!!! tip "提示"
    ...
    「網路使用行為資安政策」包含課程主題中的「[隱私瀏覽行為](../chapter/network/browser_privacy.md){target="_blank"}」、「[釣魚、詐騙](../chapter/network/phishing.md){target="_blank"}」、「[VPN](../chapter/network/vpn.md){target="_blank"}」、「[網路與 Wi-Fi](../chapter/network/wifi.md){target="_blank"}」。

## 等級說明

|                                  等級                                  | 說明                     |
| :--------------------------------------------------------------------: | ------------------------ |
|        <span style="color:#c10d30">:material-flash: 優先</span>        | 需優先且必須達成的項目。 |
|    <span style="color:#005d6c;">:material-information: 建議</span>     | 完成或達成該項目會更好。 |
|        <span style="color:#a96000">:material-alert: 須知</span>        | 需先瞭解相關的背景知識。 |
| <span style="color:#6c6c6c;">:material-format-quote-close: 選用</span> | 額外的建議或其他的選項。 |
