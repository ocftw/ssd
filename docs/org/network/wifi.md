...
<small>預計操作時間：首次整理與檢查約 0.5–1 天，其後每次檢查約 1–2 小時</small><br><small>所需預算：視現有設備而定（可能包含新路由器或 AP、Mesh 設備、外部技術支援服務費）</small>
...
2. 若部分設備由外包廠商管理，請他們提供至少上面幾個欄位的資訊，並確認未來若有異動會通知你更新清單。
