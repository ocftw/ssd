---
title: 課程課程主題簡介
summary: 本課程涵蓋威脅建模、裝置安全、身分驗證、網路使用行為、加密通訊、帳號管理、資料管理與備份，以及海外出差安全共八大主題，全面提升資訊安全技能，引導組織保護重要資料和資訊安全。
description: 本課程涵蓋威脅建模、裝置安全、身分驗證、網路使用行為、加密通訊、帳號管理、資料管理與備份，以及海外出差安全共八大主題，全面提升資訊安全技能，引導組織保護重要資料和資訊安全。
...
???+ abstract "學習歷程：「課程主題」"
    ...
    ![學習歷程流程圖：課程主題](../asserts/index_flow_chapter.svg)
