---
title: 如何貢獻
description: 資安手法持續演進，教材也需要與時俱進。本頁說明教材架構、修正類型與貢獻流程，歡迎一起協助增補與更新內容。
---
...
| **資安升級工具包**   | 顧問或內部推動者帶組織做一輪資安升級的協作流程，以及 [CSCS 社群自製教材總覽](../resources/cscs-materials.md) 的主題化導讀。       | CSCS 種子、外部顧問、內部窗口 |
